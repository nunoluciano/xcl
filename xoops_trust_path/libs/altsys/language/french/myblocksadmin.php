...
define( '_MD_A_MYBLOCKSADMIN_FMT_TAGRULE' , '%s sera rempla� par %s dans l\'affichage' ) ;
define( '_MD_A_MYBLOCKSADMIN_CTYPE' , 'Type personnalis�' ) ;
...
define( '_MD_A_MYBLOCKSADMIN_PERM_MREAD' , 'Acc�s module' ) ;
define( '_MD_A_MYBLOCKSADMIN_DBUPDATED' , 'Mise � jour avec succ�s de la Base de donn�es' ) ;
define( '_MD_A_MYBLOCKSADMIN_FMT_REMOVEBLOCK' , '%s sera supprim�. Voulez-vous confirmer?' ) ;


define( '_MD_A_MYBLOCKSADMIN_CLONEFORM' , 'Cloner le bloc' ) ;
define( '_MD_A_MYBLOCKSADMIN_NEWFORM' , 'Cr�er un bloc' ) ;
...
define( '_MD_A_MYBLOCKSADMIN_BTN_NEW' , 'Cr�er' ) ;
define( '_MD_A_MYBLOCKSADMIN_BTN_EDIT' , 'Mise � jour' ) ;

define( '_MD_A_MYBLOCKSADMIN_CTYPE_HTML' , 'Personnalis� (pleinn HTML)' ) ;
define( '_MD_A_MYBLOCKSADMIN_CTYPE_NOSMILE' , 'Personnalis� (HTML+BBCODE+AutoLink)' ) ;
define( '_MD_A_MYBLOCKSADMIN_CTYPE_SMILE' , 'Personnalis� (HTML+BBCODE+AutoLink+Smiley)' ) ;
define( '_MD_A_MYBLOCKSADMIN_CTYPE_PHP' , 'Personnalis� (PHP eval())' ) ;

define( '_MD_A_MYBLOCKSADMIN_NOTICE4COMMONFCK' , 'Si vous voulez utiliser l\'�diteur WYSIWYG, installez common / FCKeditor' ) ;


// Group permission phrases
define('_MD_A_MYBLOCKSADMIN_PERMADDNG', 'Impossible d\'ajouter %s permissions de %s pour le groupe %s');
define('_MD_A_MYBLOCKSADMIN_PERMADDOK','Ajout� %s permissions de %s pour le groupe %s');
define('_MD_A_MYBLOCKSADMIN_PERMRESETNG','impossible de supprimer permissions de groupe pour le module %s');
define('_MD_A_MYBLOCKSADMIN_PERMADDNGP', 'Tous les articles de la cat�gorie parent doivent �tre s�lectionn�s.');
