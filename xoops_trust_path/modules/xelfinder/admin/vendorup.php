    ...
    <div>
        <form action="./index.php?page=vendorup" method="post" id="xelfinder_vendorup_f"
            ...
            <table>
                <tr>
                    <td>
                        <p>PHP CLI Command<br><label><input value="php" type="radio" name="cli" checked="checked">Default
                                is "php"</label></p>
                    ...
                    <td>
                        <dl>
                            ...
                            <dd><label><input value="/usr/local/php<?php echo $curver; ?>/bin/php" type="radio"
                                              name="cli">lolipop - "/usr/local/php<?php echo $curver; ?>
                                    /bin/php"</label></dd>
                            <dd><label><input value="/usr/local/bin/php<?php echo $curverDig; ?>cli" type="radio"
                                              name="cli">XREA/CoreServer/ValueServer -
                                    "/usr/local/bin/php<?php echo $curverDig; ?>cli"</label></dd>
                            <dd><label><input value="/opt/php-<?php echo PHP_VERSION; ?>/bin/php" type="radio"
                                              name="cli">XSERVER - "/opt/php-<?php echo PHP_VERSION; ?>/bin/php"</label>
                            </dd>
                        </dl>
                    </td>
                </tr>
