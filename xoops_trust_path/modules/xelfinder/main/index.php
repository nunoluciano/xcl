...
echo '<div class="xelfinder_main_menu"><a class="button button-blue" href="#" onclick="'.htmlspecialchars($xelfinderOpenJs, ENT_COMPAT, _CHARSET).'return false;"><span>'.constant($constpref . '_OPEN_WINDOW').'</span></a></div>';
...
if ($isAdmin) {
	echo '<div class="xelfinder_main_menu"><a class="button button-green" href="#" onclick="'.htmlspecialchars($xelfinderAdminOpenJs, ENT_COMPAT, _CHARSET).'return false;"><span>'.constant($constpref . '_OPEN_WINDOW_ADMIN').'</span></a></div>';
