...
define( $constpref.'_VOLUME_SETTING_DESC' ,     '[�⥸�塼��ǥ��쥯�ȥ�̾]:[�ץ饰����̾]:[�ե������Ǽ�ǥ��쥯�ȥ�]:[ɽ��̾]:[���ץ����]<br />��ñ�̤ǵ��ҡ���Ƭ�� # ���֤���̵�뤵��ޤ���<br />���ץ����� ��|�� �Ƕ��ڤ�ޤ���<br />���̥��ץ����:<br />gid=[ͭ���ˤ��륰�롼��ID�򥫥�޶��ڤ�ǻ���]<br />defaults=[read, write, hidden, lock �γƥѡ��ߥå�����ǥե���ȤȤ���ͭ���ˤ����Τ򤽤줾���Ƭʸ�� r w h l �ǻ������: defaults=rw��]<br />uploadMaxSize=[���åץ����ɥե����륵�����ξ����(��:2M)]<br />id=[Ǥ�դΰ�դ�ID�ʸ����󥯤�URL�ϥå�������Ѥ���ޤ�)]<br />encoding=[ʸ�����󥳡��ǥ���(iconv��ͭ������)]<br />locale=[��������(����: encoding ���б�����Ŭ�ڤʥ�������)]<br />chmod=1(chmod ����ǽ�ʾ�硢�ե�����°�����ѹ������)' );
define( $constpref.'_SHARE_HOLDER' ,            '��ͭ�ե����' );
define( $constpref.'_DISABLED_CMDS_BY_GID' ,    '���롼����̵�����ޥ��' );
define( $constpref.'_DISABLED_CMDS_BY_GID_DESC','���롼����(�����Ԥ����)��̵���ˤ��륳�ޥ�ɤ� [���롼��ID]=[̵�����ޥ��(����޶��ڤ�)] �Ȥ��� ":" �Ƕ��ڤäƻ��ꤹ�롣<br />���ޥ��̾: archive, chmod, cut, duplicate, edit, empty, extract, mkdir, mkfile, paste, perm, put, rename, resize, rm, upload �ʤ�' );
...
define( $constpref.'_FTP_PATH_DESC' ,           'FTP����ϥܥ�塼��ɥ饤�Ф� "ftp" �ץ饰����ˤ���Ѥ���ޤ���<br />"ftp" �ץ饰�����ѤΤߤ����ꤹ����ϥ롼�ȥǥ��쥯�ȥ�����ˤ��Ƥ���������' );
...
define( $constpref.'_BOXAPI_SECRET_DESC' ,      'Box��ͥåȥ���ܥ�塼��Ȥ������Ѥ�����ϥХå�����ɤȤ���³�� https �����ꤷ Box https://ץꥱ������������ - redirect_uri �� "'.str_replace('https://','https://',XOOPS_URL).'/modules/'.$mydirname.'/connector.php" ���ɲä��Ƥ���������(�ɥᥤ��ʹߤΥѥ��Ͼ�ά��)' );
...
define( $constpref.'_DROPBOX_PATH_DESC' ,       '��ͭ��Dropbox�ܥ�塼��ǰ��̤˳������Ƥ�褤���ؤΥѥ�����ꤷ�ޤ���(������: "/Public")<br />Dropbox ����ϥܥ�塼��ɥ饤�Ф� "dropbox" �ץ饰����ˤ���Ѥ���ޤ���<br />"dropbox" �ץ饰�����ѤΤߤ����ꤹ����ϥ롼�ȥѥ������ˤ��Ƥ���������' );
define( $constpref.'_DROPBOX_HIDDEN_EXT' ,      '��ͭ��Dropbox��ɽ���ե�����' );
define( $constpref.'_DROPBOX_HIDDEN_EXT_DESC' , '�����ԤˤΤ�ɽ������ե�����ʥե�����̾�θ������סˤ򥫥�޶��ڤ�ǻ��ꤷ�ޤ���<br />�������/�פȤ������ϥե�������оݤȤ��ޤ���' );
...
define( $constpref.'_DROPBOX_WRITE_EXT_DESC' ,  '�񤭹��ߤ���Ĥ��륰�롼�פ˽񤭹��ߤ���Ĥ���ե�����(�ե�����̾�θ�������)�򥫥�޶��ڤ�ǻ��ꤷ�ޤ���<br />�������/�פȤ������ϥե�������оݤȤ��ޤ���<br />�����ԤϤ������¤�����ޤ���') ;
define( $constpref.'_DROPBOX_UNLOCK_EXT' ,      '��ͭ��Dropbox����å��ե�����') ;
define( $constpref.'_DROPBOX_UNLOCK_EXT_DESC' , '�ե��������å����ʤ�(����å�)�ȡ��������ư����͡��ब��ǽ�ˤʤ�ޤ���<br />���å��򤷤ʤ��ե�����(�ե�����̾�θ�������)�򥫥�޶��ڤ�ǻ��ꤷ�ޤ���<br />�������/�פȤ������ϥե�������оݤȤ��ޤ���<br />�����Ԥˤ����ƤΥե����뤬���å�����ޤ���') ;
...
define( $constpref.'_CREATIVE_CLOUD_APIKEY_DESC','Creative Cloud �� Creative SDK �Υ��᡼�����ǥ����������Ѥ������ Creative Cloud API��������ꤷ�ޤ���<br />API���� �� https://console.adobe.io/ �Ǽ����Ǥ��ޤ���' );
define( $constpref.'_ONLINE_CONVERT_APIKEY' ,   'ONLINE-CONVERT.COM API����' );
define( $constpref.'_ONLINE_CONVERT_APIKEY_DESC','ONLINE-CONVERT.COM �Υ���ƥ�ĥ���С����� API �����Ѥ������ ONLINE-CONVERT.COM API��������ꤷ�ޤ���<br />API���� �� https://apiv2.online-convert.com/docs/getting_started/api_key.html �Ǽ����Ǥ��ޤ���' );
...
define( $constpref.'_CONN_URL_IS_EXT_DESC',     'Ǥ�ջ��ꤷ�����ͥ���URL�����������Ȥξ��ˡ֤Ϥ��ס����ͥ���URL���Хå�������̿��Τ�SSL��³����URL�ξ��ϡ֤������פ����򤷤Ƥ���������<br />���������ȤΥ��ͥ�������³�����������襵���Ȥˤơ��������ȤΥ��ꥸ��ɥᥤ�󤬵��Ĥ���Ƥ���ɬ�פ�����ޤ���' );

define( $constpref.'_ALLOW_ORIGINS',            '���Ĥ���ɥᥤ�󥪥ꥸ��' );
define( $constpref.'_ALLOW_ORIGINS_DESC',       '�������ȤΥ��ͥ�������³����https://����ȤΥɥᥤ�󥪥ꥸ�����:"https://example.com" �Ǹ�Υ���å�������סˤ�Զ��ڤ�����ꤷ�ޤ���<br />���ͥ���URL���Хå�������̿��Τ�SSL��³����URL�ξ��ϡ� <strong>'.preg_replace('#^(https?://[^/]+).*$#', '$1', XOOPS_URL).'</strong> �פ���ꤹ��ɬ�פ�����ޤ���' );
