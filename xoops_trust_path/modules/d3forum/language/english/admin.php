...
define('_MD_A_D3FORUM_HELP_SYNCALLTABLES','Run this command to solve forum issues after "import" of external data from other modules.');
define('_MD_A_D3FORUM_H2_IMPORTFROM','Import');
define('_MD_A_D3FORUM_H2_COMIMPORTFROM','Import from ddefault comments');
...
define('_MD_A_D3FORUM_HELP_IMPORTFROM','You can import from newbb1,xhnewbb, and the other d3forum instances. And you should know this is not a perfect copy. Especially you should check permissions. You also have to know all data in this module will be lost when you execute the command import.');
define('_MD_A_D3FORUM_HELP_COMIMPORTFROM','Default system Comments will be imported as d3forum messages. Also you have to enable comment-integration feature to use them. (Editing templates or modify preferences etc.)');
