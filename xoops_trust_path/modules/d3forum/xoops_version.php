...
$modversion['detailed_version'] = '0.90.0';
$modversion['credits'] = "PEAK Corp. and JIDAIKOBO";
$modversion['author'] = "GIJ=CHECKMATE and JIDAIKOBO. Improved by Naao, Nao-pon, Domifara";
$modversion['help'] = "";
...
$modversion['config'][] = [
	...
	'valuetype'		=> 'text',
	'default'		=> 'xoopsdhtml',
	'options'		=> ['xoopsdhtml' => 'xoopsdhtml' /*, 'common/spaw' => 'common_spaw' */, 'common/fckeditor' => 'common_fckeditor']
];
