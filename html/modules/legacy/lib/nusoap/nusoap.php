...
class nusoap_base
{
    ...
    * @access public
    */
    public function serializeEnvelope($body, $headers=false, $namespaces=array(), $style='rpc', $use='encoded', $encodingStyle='https://schemas.xmlsoap.org/soap/encoding/')
    {
...
class nusoap_client extends nusoap_base
{
    ...
    * @access   public
    */
    public function call($operation, $params=array(), $namespace='https://tempuri.org', $soapAction='', $headers=false, $rpcParams=null, $style='rpc', $use='encoded')
    {
