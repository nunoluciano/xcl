...
ALTER TABLE newblocks CHANGE bid bid mediumint(8) unsigned NOT NULL auto_increment, CHANGE mid mid smallint (5) unsigned NOT NULL, CHANGE func_num func_num tinyint(3) unsigned NOT NULL, DROP position, CHANGE title title VARCHAR (191) NOT NULL, CHANGE side side tinyint(1) unsigned NOT NULL, CHANGE weight weight smallint (5) unsigned NOT NULL, CHANGE visible visible tinyint(1) unsigned NOT NULL, CHANGE isactive isactive tinyint(1) unsigned NOT NULL, ADD template varchar (50) NOT NULL default '', ADD bcachetime int (10) unsigned NOT NULL, ADD last_modified int (10) unsigned NOT NULL, CHANGE type block_type char (1) NOT NULL;

ALTER TABLE priv_msgs CHANGE msg_id msg_id mediumint(8) unsigned NOT NULL auto_increment, CHANGE from_userid from_userid mediumint(8) unsigned NOT NULL, CHANGE subject subject varchar (191) NOT NULL, CHANGE to_userid to_userid mediumint(8) unsigned NOT NULL, CHANGE msg_time msg_time int (10) unsigned NOT NULL, CHANGE msg_text msg_text text NOT NULL, CHANGE read_msg read_msg tinyint(1) unsigned NOT NULL;
...
ALTER TABLE stories CHANGE uid uid mediumint(8) unsigned NOT NULL, CHANGE title title VARCHAR (191) NOT NULL, CHANGE created created int (10) unsigned NOT NULL, CHANGE published published int (10) unsigned NOT NULL, CHANGE topicid topicid smallint (5) unsigned NOT NULL, CHANGE type story_type VARCHAR (5) NOT NULL, ADD expired int (10) unsigned NOT NULL, ADD comments smallint (5) unsigned NOT NULL;
