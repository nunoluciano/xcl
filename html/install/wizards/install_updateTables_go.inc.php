<?php
/**
 * Installer Wizard - Step update Tables group users
 * @package XCL
...
$error        = false;
$g_webmasters = isset( $g_webmasters ) ? $g_webmasters : 0;
$g_users      = isset( $g_users ) ? $g_users : 0;
$g_anonymous  = isset( $g_anonymous ) ? $g_anonymous : 0;
