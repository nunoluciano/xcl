...
define( "_INSTALL_L0", "Bienvenue dans l'assistant d'installation de XCL" );
define( '_INSTALL_L168', 'XCL 2.3 requiert PHP7.x.x' );
define( "_INSTALL_L70", "Changer les permissions du fichier mainfile.php afin qu'il soit accessible en écriture par le serveur (ex. chmod 777 sur un serveur UNIX/LINUX, ou vérifier les propriétés du fichier et s'assurer que l'option 'Lecture seule' n'est pas cochée sur un serveur Windows). Recharger cette page une fois les permissions changées." );

//define("_INSTALL_L71","Cliquez sur le bouton ci-dessous pour commencer l'installation.");
define( "_INSTALL_L1", "Ouvreir le fichier mainfile.php avec un éditeur de texte et chercher le code suivant à la ligne 31 :" );
define( "_INSTALL_L2", "Maintenant, changer cette ligne en :" );
define( "_INSTALL_L3", "Ensuite, à la ligne 35, changer %s en %s" );
define( "_INSTALL_L4", "OK, j'ai saisi les paramètres ci-dessus, laissez-moi essayer à nouveau !" );
define( "_INSTALL_L5", "ATTENTION !" );
define( "_INSTALL_L6", "Il y a une différence entre la configuration XOOPS_ROOT_PATH à la ligne 31 du fichier mainfile.php et les informations du chemin racine détectées." );
define( "_INSTALL_L7", "Vos paramètres : " );
define( "_INSTALL_L8", "Paramètres détectés : " );
define( "_INSTALL_L9", "( Sur les plateformes Windows, ce message d'erreur peut s'afficher même si la configuration est correcte. Si c'est le cas, presser le bouton ci-dessous pour continuer)" );
define( "_INSTALL_L10", "Presser le bouton ci-dessous pour continuer si la configuration est correcte." );
define( "_INSTALL_L11", "Le chemin du répertoire racine de XCL sur le serveur : " );
define( "_INSTALL_L12", "L'URL du répertoire racine de XCL : " );
...
define( "_INSTALL_L19", "%s est le nom de votre base de données dans laquelle les tables de XCL seront créées." );
...
define( "_INSTALL_L22", "Essayer de créer la base de données ?" );
...
define( "_INSTALL_L63", "Le préfixe sera ajouté à toutes les tables créées pour éviter un conflit de noms dans la base de données. Si vous n'êtes pas sûr, utilisez juste par défaut 'xcl'." );
define( "_INSTALL_L54", "Utiliser les connexions persistentes?" );
define( "_INSTALL_L69", "Par défaut c'est 'NON'. Choisir 'NON' si vous n'êtes pas sûr." );
define( "_INSTALL_L55", "Chemin physique de XCL" );
define( "_INSTALL_L59", "Chemin physique de votre répertoire racine XCL sans le slash / de fin." );
...
define( "_INSTALL_L56", "Chemin virtuel de XCL (URL)" );
define( "_INSTALL_L58", "Chemin virtuel de votre répertoire racine XCL sans le slash / de fin." );
...
define( "_INSTALL_L35", "Si vous avez des erreurs, merci de contacter l'équipe de support sur <a href='http://github.com/xoopscube/xcl' target='_blank'>XoopsCube-XCL</a>" );
...
define( '_INSTALL_L166', 'Vérification des permissions des fichiers de XOOPS_TRUST_PATH' );
define( '_INSTALL_L167', 'Vérifier les permissions de Trust Path' );
define( "_INSTALL_L94", "Vérifier le chemin & l'URL" );
define( "_INSTALL_L127", "Vérification du chemin des fichiers & de l'URL." );
define( "_INSTALL_L95", "Impossible de détecter le chemin physique de votre répertoire XCL." );
...
define( "_INSTALL_L108", "La connexion au serveur de base données est valide." );
...
define( "_INSTALL_L111", "La connexion à la base de données est valide.<br />Pressez le bouton ci-dessous pour créer les tables dans la base de données." );
...
define( "_INSTALL_L130", "L'installateur a détecté des tables pour XOOPS dans votre base de données.<br />L'installateur va maintenant essayer de mettre à jour votre base de données pour XCL" );
define( "_INSTALL_L131", "Les Tables pour XCL existe déjà dans votre base de données." );
...
define( "_INSTALL_L141", "L'installateur va maintenant mettre à jour chaque module pour qu'ils fonctionnent avec XCL<br />Assurez-vous d'avoir téléchargé tous les fichiers de XCL sur votre serveur.<br />Cela peut prendre un certain temps pour finir." );
define( "_INSTALL_L142", "Mise à jour des modules..." );
define( "_INSTALL_L143", "L'installateur va maintenant mettre à jour les données de configuration de XOOPS pour être utilisées avec XCL" );
...
define( "_INSTALL_L149", "L'installateur va maintenant mettre à jour les envois de commentaires de XCL pour être utilisés dansXCL.<br />Cela peut prendre un certain temps pour finir." );
define( "_INSTALL_L150", "L'installateur va maintenant mettre à jour les émoticones et les images de classement utilisateur pour être utilisés dans XCL.<br />Cela peut prendre un certain temps pour finir." );
define( "_INSTALL_L151", "L'installateur va maintenant mettre à jour les avatars utilisateurs pour être utilisés dans XCL<br />Cela peut prendre un certain temps." );
