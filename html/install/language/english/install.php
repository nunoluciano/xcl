...
define('_INSTALL_L19', '%s is the name of your database in which XCL tables will be created.');
...
define('_INSTALL_L131', 'Tables for XCL already exist in your database.');
...
define('_INSTALL_L141', 'The installer will now update each module to work with XCL.<br>Make sure that you have uploaded all files in XCL package to your server.<br>This may take a while to complete.');
define('_INSTALL_L142', 'Updating modules..');
define('_INSTALL_L143', 'The installer will now update configuration data of XOOPS 1.3.x to be used with XCL.');
...
define('_INSTALL_L149', 'The installer will now update comment posts in XOOPS 1.3.x to be used in XCL.<br>This may take a while to complete.');
define('_INSTALL_L150', 'The installer will now update the smiley and user rank images to be used with XCL.<br>This may take a while to complete.');
define('_INSTALL_L151', 'The installer will now update the user avatar images to be used in XCL.<br>This may take a while to complete.');
