...
<p>
XOOPS Cube Legacyは、<a href='https://github.com/xoopscube/xcl/blob/master/docs/GPL_V2.txt' rel='external'>GNU 一般公衆利用許諾契約書(GPL)</a>（参考：<a href='http://www.opensource.jp/gpl/gpl.ja.html' rel='external'>日本語訳</a>）というライセンスでリリースされており、自由に使用し、また改変できます。再配布もGPLの条項にしたがっていれば、自由に行うことができます。
</p>
<u><b>必要なソフトウエア</b></u>
<p>
<ul>
