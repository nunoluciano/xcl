 ...
 * @author Minahito, 2008/11/16 10:05:55
 ...
 *
 * @attention
 *   This is the candidate as a new delegate style, which has a silly name to avoid conflict with the old XCube_Delegate.
 *   After the replacement, we will change everything.
 */
class XCube_Delegate {
	 ...
	 * @brief bool
	 *
	 * If register() fails, this flag become true.
	 * That problem is raised, when register() is called before $root
	 * come to have the delegate manager.
	 *
	 * @var bool
	 */
	 ...
	 * @return void
	 * @attention
	 *     This is a special method, it is not recommended to use this with XCube.
	 */
