...
if ( !defined('XOOPS_MAINFILE_INCLUDED') ) {
    ...
    // Example: define('XOOPS_ROOT_PATH', 'D:/local/sites/y7gitea/app/public/xcl/html');
    define('XOOPS_ROOT_PATH', 'D:/local/sites/y7gitea/app/public/xcl/html');
    ...
    define('XOOPS_TRUST_PATH', 'D:/local/sites/y7gitea/app/public/xcl/xoops_trust_path');

    // XOOPS Virtual Path (URL)
    // Virtual path to your main XOOPS directory WITHOUT trailing slash
    // Example: define('XOOPS_URL', 'https://y7gitea.local/xcl/html');
    define('XOOPS_URL', 'https://y7gitea.local/xcl/html');
