...
if ( !defined("XOOPS_MAINFILE_INCLUDED") ) {
    ...
    // Example: define('XOOPS_ROOT_PATH', '/app/public/develop');
    define('XOOPS_ROOT_PATH', '/app/public/master/html');
    ...
    define('XOOPS_TRUST_PATH', '/app/public/master/xoops_trust_path');

    // XOOPS Virtual Path (URL)
    // Virtual path to your main XOOPS directory WITHOUT trailing slash
    // Example: define('XOOPS_URL', 'https://master.test/develop');
    define('XOOPS_URL', 'https://master.test/master/html');
    ...
    define('XOOPS_DB_NAME', 'xclmaster');
